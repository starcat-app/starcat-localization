...
| 状态 | 语言 |
|---|---|
| 已发布 | `en` 英语（源语言）、`zh-Hans` 简体中文、`zh-Hant` 繁体中文、`ja` 日语、`ko` 韩语、`de` 德语、`fr` 法语、`es` 西班牙语、`pt-BR` 巴西葡萄牙语、`it` 意大利语、`ru` 俄语、`nl` 荷兰语、`pl` 波兰语、`uk` 乌克兰语、`tr` 土耳其语、`vi` 越南语、`id` 印度尼西亚语、`ar` 阿拉伯语 |
| 草稿 | 无 |
